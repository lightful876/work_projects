...
os.chdir('C:\\Users\\roy_shaw\\Desktop\\Work_Files\\E-Commerce Report Automated Scripts\\Coding output\\Alt Channel Inputs\\Monthly\\FY24')
...
while j in range(len(df_table['Country'])):
    ...
    j+=1
#count_vals.append(len(SC_vals),len(cash_vals),len(PoD_vals),len(PIS_vals))
...
df_table.to_csv(r'C:\\Users\\roy_shaw\\Desktop\\Work_Files\\E-Commerce Report Automated Scripts\\Coding output\\Alt Channel Inputs\\week_12_Alt.csv')
